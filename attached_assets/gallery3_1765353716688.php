...
<head>
    ...
    <title>Sachan Krishi Yantra Udyog | Gallery</title>
    <!-- favicons Icons -->
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
      ...
      <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h2 class="page-header__title bw-split-in-down">Our Gallery</h2>
    ...
    <div class="row">
        ...
        <div class="col-lg-3" id="gallery">
            <img src="assets/images/gallery/g8.png" alt="">
        </div>
        <div class="col-lg-3" id="gallery">
