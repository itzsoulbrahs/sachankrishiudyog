...
<head>
    ...
    <title> Rotavator Manufacturer In Chattisgarh</title>
    <meta name="description=" content="we Sachan Krishi Yantra Udyog are the leading Manufacturer, Wholesaler of a wide range of  Rotavator Manufacturer In chattisgarh."/>
    <link rel="canonical" href="https://sachankrishiyantraudyog.com/rotavator-manufacturer-in-chattisgarh.php"/>
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
      ...
      <section class="page-header">
            ...
            <!-- /.page-header__bg -->
            <div class="container">
                <h1 class="page-header__title bw-split-in-down">Rotavator Manufacturer In Chattisgarh</h1>
...
<div class="container" >
    <div class="row">
        <div class="col-lg-6" id="gallery">
            <img src="assets/images/products/p5.jpg" alt="Rotavator">
        </div>
        <div class="col-lg-6" >
